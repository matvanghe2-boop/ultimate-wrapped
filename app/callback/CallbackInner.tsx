"use client";
// ============================================================
// app/callback/CallbackInner.tsx
// Logique OAuth — doit être "use client" et dans un Suspense
// ============================================================
  ...
  useEffect(() => {
    ...
    async function handleCallback() {
      try {
        ...
        setState("error");
        setErrorMessage(
          err instanceof Error ? err.message : "Erreur lors de l'échange du token."
        );
      }
    }
